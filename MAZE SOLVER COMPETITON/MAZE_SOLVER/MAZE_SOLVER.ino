...
//JUST HABD FROM AYMAN

/*
     digitalWrite(in1, LOW);
     digitalWrite(in2, HIGH);
     delay(10);
     analogWrite(enA, 200 * 1.2);
     analogWrite(enB, 200);
     delay(180);
     analogWrite(enA, 0);
     analogWrite(enB, 0);
  ...
  */
   ...
   analogWrite(enA, 0);   // left motor
   analogWrite(enB, 65);   // right motor
...
void turnBack_until_ZeroError() {
  analogWrite(enA, 0);
    ...
    analogWrite(enB, 0);
     ...
     digitalWrite(in4,LOW);
     digitalWrite(in3,HIGH);
   analogWrite(enA, 200 * 1.2);   // left motor
   analogWrite(enB, 200);   // right motor
  //delay(600);
  
   readSensors();
   thresholdSensor();

  while(sensorReading[1] == 0 && sensorReading[3] == 0 && sensorReading[2] == 0)
   {
     readSensors();
     thresholdSensor();
   }
 ...
 analogWrite(enA, 90 * 1.2);   // left motor
 analogWrite(enB, 90);   // right motor
  /* 
...
void MazeSolve()
{
  ...
  while(1)
  {
    ...
    // solved the maze.
   /* if(sensorReading[1] == 1 && sensorReading[2] == 1 && sensorReading[3] == 1 && sensorReading[0] == 0 && sensorReading[4] == 0) {
      analogWrite(enA, 0);   // left motor
      analogWrite(enB, 0);   // right motor
      break;
    }*/
